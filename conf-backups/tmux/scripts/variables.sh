...
# General options
filename_suffix="#{session_name}-#{window_index}-#{pane_index}-%Y%m%dT%H%M%S.tmux.log"

# Logging options
default_logging_path="$HOME/.tmux-log"
...
default_screen_capture_path="$HOME/.tmux-log"
...
default_save_complete_history_path="$HOME/.tmux-log"
